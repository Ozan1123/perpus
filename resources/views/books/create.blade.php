        ...
        <div class="relative z-10">
            <div class="flex flex-col md:flex-row md:items-center text-white">
                <div>
                    ...
                    <p class="text-blue-100 text-lg">Tambahkan buku ke koleksi perpustakaan</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="4" placeholder="Masukkan deskripsi singkat tentang buku"
                                class="block w-full px-4 py-3 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-150 resize-none">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-2 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="isbn" value="{{ old('isbn') }}" placeholder="Contoh: 978-0-123456-47-2"
                                class="block w-full px-4 py-3 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-150">
                            @error('isbn')
                                <p class="text-red-500 text-sm mt-2 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-blue-400 transition-colors duration-150"
                                id="dropZone">
                        ...
                        <div class="sticky top-8">
                            ...
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
                                ...
                                <div class="text-center mb-4">
                                    <div id="coverPreview"
                                        class="w-48 h-64 bg-gray-200 rounded-lg flex items-center justify-center mx-auto shadow-lg">
                                    ...
                                    <img id="previewImage"
                                        class="w-48 h-64 object-cover rounded-lg shadow-lg mx-auto hidden">
                                </div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        <label
                                            class="text-xs font-medium text-gray-500 uppercase tracking-wide">Judul:</label>
                                        <div id="titlePreview" class="text-lg font-semibold text-gray-900 min-h-[1.75rem]">-
                                        </div>
                                    </div>
                                    <div>
                                        <label
                                            class="text-xs font-medium text-gray-500 uppercase tracking-wide">Penulis:</label>
                                        <div id="authorPreview" class="text-sm text-gray-700 min-h-[1.25rem]">-</div>
                                    </div>
                                    <div>
                                        <label
                                            class="text-xs font-medium text-gray-500 uppercase tracking-wide">Deskripsi:</label>
                                        <div id="descriptionPreview" class="text-sm text-gray-600 min-h-[1.25rem]">-</div>
                                    </div>
                                    <div>
                                        <label
                                            class="text-xs font-medium text-gray-500 uppercase tracking-wide">ISBN:</label>
